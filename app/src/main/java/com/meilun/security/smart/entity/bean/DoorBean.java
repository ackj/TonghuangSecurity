...
public class DoorBean implements Serializable {
    ...
    public String toString() {
        return "Dev_Type:" + Dev_Type + " Dev_Serial:" + Dev_Serial + " Dev_Psw:" + Dev_Psw + " Lock_Psw:" + Lock_Psw + " Channel_Num:" + Channel_Num + "Pir_State:" + Pir_State + " Tamper_State:" + Tamper_State + " Door_Audio:" + Door_Audio;
    }
}
