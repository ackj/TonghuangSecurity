...
public class PlayBackActivity extends BasePlayBackActivity {
    ...
    public void regFilter() {
        ...
        filter.addAction(CameraPlay2Activity.P2P_REJECT);
        filter.addAction(CameraPlay2Activity.P2P_ACCEPT);
        filter.addAction(CameraPlay2Activity.P2P_READY);
...
//                txText.append("\n 监控数据接收");
            ...
            } else if (intent.getAction().equals(CameraPlay2Activity.P2P_READY)) {
//                txText.append("\n 监控准备,开始监控");
            ...
            } else if (intent.getAction().equals(CameraPlay2Activity.P2P_REJECT)) {
//                txText.append("\n 监控挂断");
            }
        }
    };
